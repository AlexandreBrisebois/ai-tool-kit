...
# 🛠️ AI Tool Kit: MLX-LM Bootstrap Script
# ========================================
# This script ensures the local Python virtual environment is set up and
# correctly configured before running the MLX-LM manager.
#
# Usage:
#   ./mlx-lm.sh [command] [options] (e.g. ./mlx-lm.sh list)
#
